...
#[ORM\Index(name: 'map_place_photo_place_idx', columns: ['place_id'])]
#[Vich\Uploadable]
class MapPlacePhoto
{
    ...
    public ?MapPlace $place = null;

    #[ORM\Column(length: 255, nullable: true)]
    private ?string $fileName = null;

    #[Vich\UploadableField(mapping: 'map_place_photos', fileNameProperty: 'fileName')]
    ...
    {
        return $this->fileName ? '/uploads/map-places/'.$this->fileName : null;
    }
